...
export default function Login(props: MacActions) {
  ...
  return (
    <div
      ...
      onClick={() => loginHandle()}
    >
      <div className="inline-block w-auto relative top-1/2 -mt-32">
        {/* Avatar */}
        ...
        {/* Password Input */}
        <div className="mx-auto grid grid-cols-5 w-44 h-8 mt-10 rounded-md backdrop-blur-2xl bg-gray-300/50">
          <input
